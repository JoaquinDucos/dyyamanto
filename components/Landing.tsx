  ...
  return (
    <div className="h-full bg-slate-50 flex flex-col items-center justify-center p-6 text-center overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 animate-fade-in flex flex-col h-full justify-center">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-2xl shadow-indigo-100 border border-slate-100 space-y-4 relative overflow-hidden shrink-0">
            ...
            <p className="text-slate-600 leading-relaxed font-light text-sm relative z-10">
                ...
                <span className="font-semibold text-slate-800">Elige tu experiencia:</span>
            </p>

            <div className="grid gap-3 relative z-10">
                <button 
                  onClick={() => onNavigate('simulator')} 
                  className="group relative w-full flex items-center p-3 bg-slate-900 rounded-2xl overflow-hidden hover:scale-[1.02] active:scale-95 transition-all duration-300 shadow-lg shadow-slate-900/20"
                >
                    ...
                    <div className="text-left relative z-10 flex-1">
                        ...
                        <p className="text-slate-400 text-[10px] group-hover:text-indigo-100">Equilibra la Estructura.</p>
                    </div>
                ...
                <button 
                  ...
                  className="group relative w-full flex items-center p-3 bg-white border-2 border-slate-100 rounded-2xl overflow-hidden hover:border-indigo-500 hover:bg-slate-50 active:scale-95 transition-all duration-300 shadow-sm"
                >
                    ...
                    <div className="text-left flex-1">
                        ...
                        <p className="text-slate-500 text-[10px]">Gestiona la crisis del chat.</p>
                    </div>
                ...
                <button 
                  ...
                  className="group relative w-full flex items-center p-3 bg-white border-2 border-slate-100 rounded-2xl overflow-hidden hover:border-pink-500 hover:bg-pink-50 active:scale-95 transition-all duration-300 shadow-sm"
                >
                    <div className="h-10 w-10 bg-pink-100 text-pink-600 rounded-xl flex items-center justify-center text-xl mr-3">
                        📊
                    </div>
                    <div className="text-left flex-1">
                        <h3 className="font-bold text-slate-900 text-base">Mapa Cultural</h3>
                        <p className="text-slate-500 text-[10px]">Explora el ADN Dyamanto.</p>
                    </div>
                    <span className="text-slate-300 group-hover:text-pink-500">→</span>
                </button>
            </div>
        </div>

        <div className="text-xs text-slate-400 pt-2 shrink-0">
